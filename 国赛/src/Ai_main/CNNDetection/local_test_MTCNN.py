...
# CUDA_VISIBLE_DEVICES=0 python CNNDetection/local_test_MTCNN.py --model_path CNNDetection/model/tag_testdata_B_epoch_3_C1acc_90.31_resnet50_Noforzen_noDropout.pth --dataroot tag_testdata_A
